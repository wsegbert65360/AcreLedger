...
- Use progressive context loading: read `AGENTS.md` → identify task → read relevant source files → read targeted `BLUEPRINT.md` sections only when needed.
