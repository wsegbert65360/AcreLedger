...
import { Sprout, Droplets, Plus, Trash2, X, Download, LogOut, Cloud, Database, ShieldAlert, Sun, Moon, Laptop, FlaskConical } from 'lucide-react';
...
function BackupManager() {
  ...
  const handleBackup = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `acreledger-backup-${new Date().toISOString().split('T')[0]}.json`;
      a.click();
