      ...
      <main className="max-w-lg mx-auto px-4 py-6 space-y-6 lg:max-w-5xl lg:px-8">
        ...
        <section className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-muted text-muted-foreground text-xs font-bold uppercase tracking-tight hover:bg-muted/80 transition-colors"
          >
            <History size={14} />
            View Full History
          </button>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="p-3 rounded-2xl bg-muted/50 border border-border/60">
                <div className="text-[11px] font-black text-muted-foreground uppercase tracking-tight mb-1 leading-none">{stat.sub ? `${stat.sub} ${stat.label}` : stat.label}</div>
        ...
        {latestSpray && (
          <section className="bg-card border border-border rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-y-4">
              <div>
                <label className="text-xs font-black text-muted-foreground uppercase tracking-tight block mb-0.5">Application Date</label>
              ...
              <div>
                <label className="text-xs font-black text-muted-foreground uppercase tracking-tight block mb-0.5">Rain Since Spray</label>
              ...
              <div>
                <label className="text-xs font-black text-muted-foreground uppercase tracking-tight block mb-0.5">Target Pest</label>
            ...
            <div className="flex gap-2 pt-2 border-t border-border/70">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-muted text-muted-foreground text-xs font-bold uppercase tracking-tight hover:bg-muted/80 transition-colors"
              >
                <FileText size={14} />
                View Record
              </button>
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-spray/10 text-spray text-xs font-bold uppercase tracking-tight hover:bg-spray/20 transition-colors"
              >
        ...
        <section id="history-section" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs font-black text-muted-foreground uppercase tracking-tight hover:text-foreground transition-colors"
            >
              View All Activity
            </button>
          </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-2 shadow-sm">
            ...
            {unifiedRecords.length > 8 && (
              <button
                onClick={() => navigate('/activity')}
                className="w-full py-4 text-xs font-bold text-muted-foreground uppercase tracking-tight hover:text-foreground transition-colors"
              >
        ...
        <section className="bg-card border border-border rounded-2xl p-6 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-y-4 text-xs">
            <div>
              <label className="text-xs font-black text-muted-foreground uppercase tracking-tight block mb-0.5">Acreage</label>
              <div className="font-bold text-foreground">{field.acreage} Calculated Acres</div>
            </div>
            <div>
              <label className="text-xs font-black text-muted-foreground uppercase tracking-tight block mb-0.5">Location</label>
            ...
            <div>
              <label className="text-xs font-black text-muted-foreground uppercase tracking-tight block mb-0.5">Irrigation</label>
              <div className="font-bold text-foreground">{field.irrigationPractice || 'Non-Irrigated'}</div>
            </div>
            <div>
              <label className="text-xs font-black text-muted-foreground uppercase tracking-tight block mb-0.5">Intended Use</label>
              <div className="font-bold text-foreground">{field.intendedUse || 'Cash Grain'}</div>
            </div>
            <div>
              <label className="text-xs font-black text-muted-foreground uppercase tracking-tight block mb-0.5">Share %</label>
